jQuery(document).ready(function($) {
    ...
    $(function(){
      $('#form').submit(function(e){
        ...
        var formdata='name='+$('#name').val()+'&phone='+$('#phone').val();
        var form =this;
        $.ajax({
            url: '/mail.php',
            type: 'POST',
        ...
        .done(function(respond) {
            form.reset();
            $('.contact').hide();
            $('.popup').append('<p class="popup_span">'+respond+'</p>').fadeOut(3000);
            $('.popup_overlay').fadeOut(3000);
            setTimeout(function() {$('.popup_span').remove();}, 3000);
            $('.form-button-top').click(function() {
        ...
        .fail(function() {
            form.reset();
            $('.contact').hide();
            $('.popup').append('<p class="popup_span">Произошла ошибка. Повторите попытку позже.</p>').fadeOut(3000);
            $('.popup_overlay').fadeOut(3000);
            setTimeout(function() {$('.popup_span').remove();}, 3000);
            $('.form-button-top').click(function() {
              $('#form').css('display','block');
